...
import { getAllSessions, createSession, updateSession, deleteSession } from '@/lib/firestore/sessions';
...
export function AdminSessions() {
    ...
    const [editingSession, setEditingSession] = useState<SessionsSession | null>(null);
    const [saving, setSaving] = useState(false);

    // Form state
    const [formData, setFormData] = useState({
        title: '', speaker: '', time: '09:00', location: '', day: 1,
        type: 'talk' as SessionsSession['type'], duration: 45, order: 1,
    ...
    const handleEdit = (session: SessionsSession) => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800">Event Sessions</h2>
